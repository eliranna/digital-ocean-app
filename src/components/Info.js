...
const info = [
    ...
    },
    {
        ...
        answare: "עלות המסלול לתלמיד הינה 6,750 ש״ח לפני מע״מ. ניתן לבצע את התשלום ע״י כרטיס אשראי דרך אתר זה. יש להדגיש כי התשלום יבוצע בפועל אם וכאשר תאושר קבלתו של התלמיד למסלול על סמך גיליון ציוניו האחרון, אותו תתבקשו לשלוח אלינו לאחר ההרשמה."
    }
]
