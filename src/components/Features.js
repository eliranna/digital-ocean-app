...
const features = [
    ...
    {
        icon: "./assets/learn-coding2.svg",
        title: 'ללמוד וליישם',
        description: " פיתוח יכולת החשיבה הלוגית וגישה שיטתית לפתרון בעיות. הכרת הנושאים התיאורטיים המהותיים לפיתוח תוכנה, לצד התנסות מעמיקה בפיתוח תוכנה ובתכנות."
    }
]
